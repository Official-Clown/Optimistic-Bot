...
global.ownername = "_🇵🇰𝙊𝙋𝙏𝙄𝙈𝙄𝙎𝙏𝙄𝘾 𝘽𝙊𝙔🇵🇰_" //ur owner name
global.ytname = "🇾🇪𝙊𝙋𝙏𝙄𝙈𝙄𝙎𝙏𝙄𝘾 𝘽𝙊𝙔🇾🇪" //ur yt chanel name
global.socialm = "🇸🇲𝙊𝙋𝙏𝙄𝙈𝙄𝙎𝙏𝙄𝘾 𝘽𝙊𝙔🇸🇲" //ur github or insta name
...
global.botname = 'Optimistic-Bot' //ur bot name
global.ownername = "_🇵🇰𝙊𝙋𝙏𝙄𝙈𝙄𝙎𝙏𝙄𝘾 𝘽𝙊𝙔🇵🇰_"
...
global.author = "_🇵🇰𝙊𝙋𝙏𝙄𝙈𝙄𝙎𝙏𝙄𝘾 𝘽𝙊𝙔🇵🇰_" //ur sticker watermark author
global.wm = "Team Clown Bot Inc." //ur watermark

// Other
global.sessionName = 'clownsession'
global.prefa = ['','!','.','#','&']
global.sp = ''
global.mess = {
    success: 'Done✓',
...
global.thum = fs.readFileSync("./ClownMedia/theme/optimisticpic.jpg") //ur thumb pic
global.log0 = fs.readFileSync("./ClownMedia/theme/optimisticpic.jpg") //ur logo pic
global.err4r = fs.readFileSync("./ClownMedia/theme/optimisticpic.jpg") //ur error pic
global.thumb = fs.readFileSync("./ClownMedia/theme/optimisticpic.jpg") //ur thumb pic
